...
// Start server
app.listen(PORT, () => {
    console.log(`🚀 VincAI Advanced Backend Server running on http://localhost:${PORT}`);
    console.log(`🌐 Real-time web scraping and intelligent analysis system active`);
    console.log(`📡 API endpoint: http://localhost:${PORT}/api/chat`);
    console.log(`🔧 Features: Multi-source scraping, content analysis, structured responses`);
});
